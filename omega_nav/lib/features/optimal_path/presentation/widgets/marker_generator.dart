...
class MarkerGenerator {
  ...
  MarkerGenerator({required this.markerWidgets, required this.callback});

  void generate(BuildContext context) {
    WidgetsBinding.instance
        .addPostFrameCallback((timeStamp) => afterFirstLayout(context));
  }
...
class _MarkerHelper extends StatefulWidget {
  ...
  @override
  State<_MarkerHelper> createState() => _MarkerHelperState();
}
